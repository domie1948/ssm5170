...
public class ChuzhenxinxiEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public ChuzhenxinxiEntity() {
		
	}
	
	public ChuzhenxinxiEntity(T t) {
		try {
	 ...
	 * 设置：出诊时间
	 */
	public void setChuzhenshijian(Date chuzhenshijian) {
		this.chuzhenshijian = chuzhenshijian;
	}
	/**
	 * 获取：出诊时间
	 */
	public Date getChuzhenshijian() {
