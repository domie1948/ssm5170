 ...
 */
@RestController
@RequestMapping("/yuyueshijianduan")
public class YuyueshijianduanController {
    @Autowired
    private YuyueshijianduanService yuyueshijianduanService;
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,YuyueshijianduanEntity yuyueshijianduan, HttpServletRequest request){

        EntityWrapper<YuyueshijianduanEntity> ew = new EntityWrapper<YuyueshijianduanEntity>();
    	PageUtils page = yuyueshijianduanService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, yuyueshijianduan), params), params));
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,YuyueshijianduanEntity yuyueshijianduan, HttpServletRequest request){
        EntityWrapper<YuyueshijianduanEntity> ew = new EntityWrapper<YuyueshijianduanEntity>();
    	PageUtils page = yuyueshijianduanService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, yuyueshijianduan), params), params));
		request.setAttribute("data", page);
        return R.ok().put("data", page);
     ...
     */
    @RequestMapping("/add")
    public R add(@RequestBody YuyueshijianduanEntity yuyueshijianduan, HttpServletRequest request){
    	yuyueshijianduan.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
    	//ValidatorUtils.validateEntity(yuyueshijianduan);
    ...
    public R update(@RequestBody YuyueshijianduanEntity yuyueshijianduan, HttpServletRequest request){
        //ValidatorUtils.validateEntity(yuyueshijianduan);
        yuyueshijianduanService.updateById(yuyueshijianduan);//全部更新
        return R.ok();
    }
    ...
    public R delete(@RequestBody Long[] ids){
        yuyueshijianduanService.deleteBatchIds(Arrays.asList(ids));
        return R.ok();
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<YuyueshijianduanEntity> wrapper = new EntityWrapper<YuyueshijianduanEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = yuyueshijianduanService.selectCount(wrapper);
