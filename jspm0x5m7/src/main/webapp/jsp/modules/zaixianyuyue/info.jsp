						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="guahaofei" name="guahaofei" class="form-control" v-model="ruleForm.guahaofei" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>时间段</label>
									...
									<input id="jiuzhenmiaoshu" name="jiuzhenmiaoshu" class="form-control" v-model="ruleForm.jiuzhenmiaoshu" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>健康码</label>

									<img id="jiankangmaImg" src="" width="100" height="100">
									</div>
									<div class="form-group col-md-6">
									<label>日期</label>
