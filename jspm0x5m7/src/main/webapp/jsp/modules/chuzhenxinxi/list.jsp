...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">出诊信息管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>出诊信息列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">出诊信息列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('chuzhenshijian')">出诊时间<i id="chuzhenshijianIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('keyuerenshu')">可约人数<i id="keyuerenshuIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var chuzhenshijianCell  = document.createElement('td');

						  chuzhenshijianCell.innerHTML = item.chuzhenshijian;


			row.appendChild(chuzhenshijianCell);
			var keyuerenshuCell  = document.createElement('td');

						 keyuerenshuCell.innerHTML = item.keyuerenshu;


			row.appendChild(keyuerenshuCell);
			...
			crossBtn1.setAttribute("onclick","crossTable(" + item.id + ",\"zaixianyuyue\")");
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("chuzhenxinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"chuzhenxinxi");
