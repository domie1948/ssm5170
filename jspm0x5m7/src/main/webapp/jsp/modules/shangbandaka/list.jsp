...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">上班打卡管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>上班打卡管理</span></li>
								<li class="breadcrumb-item active"><span>上班打卡列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">上班打卡列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<select name="dakaleixing" id="dakaleixingSelect" class="form-control form-control-sm" aria-controls="tableId">
										<option value=" "> </option>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('dakaleixing')">打卡类型<i id="dakaleixingIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			...
			var dakaleixingIndex = document.getElementById("dakaleixingSelect").selectedIndex;
			var dakaleixingOptions = document.getElementById("dakaleixingSelect").options;
			var dakaleixingSelectedOption = dakaleixingOptions[dakaleixingIndex]
			if(dakaleixingSelectedOption.text != null && dakaleixingSelectedOption.text != ''){
				searchForm.dakaleixing = "%" + dakaleixingSelectedOption.text + "%";
			}
			getDataList();
		}		
		// 获取数据列表
        function getDataList() {
			http("shangbandaka/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
				...
				dakaleixing : searchForm.dakaleixing,	
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			var dakaleixingCell  = document.createElement('td');

						  dakaleixingCell.innerHTML = item.dakaleixing; 

			row.appendChild(dakaleixingCell);
	...
	// 导出
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("shangbandaka/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"shangbandaka");
