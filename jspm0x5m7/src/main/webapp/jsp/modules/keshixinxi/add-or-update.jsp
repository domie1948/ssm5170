		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑科室信息</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>科室信息管理</span></li>
								<li class="breadcrumb-item active"><span>编辑科室信息</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">科室信息信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>科室介绍</label>
										<textarea name="keshijieshao" class="form-control" id="keshijieshao" rows="3"></textarea>
									</div>
									<div class="form-group col-md-6">
										<label>科室位置</label>
										<input id="keshiweizhi" name="keshiweizhi" class="form-control" placeholder="科室位置">
									</div>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "keshixinxi/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("keshixinxi/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("keshixinxi/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			...
			$("#keshijieshao").val(ruleForm.keshijieshao);
			$("#keshiweizhi").val(ruleForm.keshiweizhi);	
		}		
		//图片显示
		function showImg(){
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.keshijieshao != null && res.data.keshijieshao != ''){

					$("#keshijieshao").val(res.data.keshijieshao);
					}
					if(res.data != null && res.data != '' && res.data.keshiweizhi != null && res.data.keshiweizhi != ''){

					$("#keshiweizhi").val(res.data.keshiweizhi);
					}
				}
			});  
            }
