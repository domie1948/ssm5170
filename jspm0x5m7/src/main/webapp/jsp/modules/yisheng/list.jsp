...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>医生列表</span></li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<select name="zhicheng" id="zhichengSelect" class="form-control form-control-sm" aria-controls="tableId">
										<option value=" "> </option>
									...
									<select name="keshi" id="keshiSelect" class="form-control form-control-sm" aria-controls="tableId">
									</select>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('shanzhang')">擅长<i id="shanzhangIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			...
			var zhichengIndex = document.getElementById("zhichengSelect").selectedIndex;
			var zhichengOptions = document.getElementById("zhichengSelect").options;
			var zhichengSelectedOption = zhichengOptions[zhichengIndex]
			if(zhichengSelectedOption.text != null && zhichengSelectedOption.text != ''){
				searchForm.zhicheng = "%" + zhichengSelectedOption.text + "%";
			}
			var keshiIndex = document.getElementById("keshiSelect").selectedIndex;
			var keshiOptions = document.getElementById("keshiSelect").options;
			var keshiSelectedOption = keshiOptions[keshiIndex]
			if(keshiSelectedOption.text != null && keshiSelectedOption.text != ''){
				searchForm.keshi = "%" + keshiSelectedOption.text + "%";
			}
			getDataList();
		}		
		// 获取数据列表
		...
		function setDataRow(item,number){
			...
			var shanzhangCell  = document.createElement('td');

						 shanzhangCell.innerHTML = item.shanzhang;


			row.appendChild(shanzhangCell);
