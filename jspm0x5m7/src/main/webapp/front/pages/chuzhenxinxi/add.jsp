			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
                        ...
                        <div class="layui-input-block">
                            <select name="yishenggonghao" id="yishenggonghao" lay-filter="yishenggonghao">
						...
						<div class="layui-input-block">
							<input v-model="detail.shanzhang" type="text" name="shanzhang" id="shanzhang" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">出诊时间：</label>
						<div class="layui-input-block">
							<input type="text" name="chuzhenshijian" id="chuzhenshijian" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">可约人数：</label>
						<div class="layui-input-block">
							<input v-model="detail.keyuerenshu" type="text" name="keyuerenshu" id="keyuerenshu" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
				...
				form.on('submit(*)', function(data) {
					...
					// 提交数据
					http.requestJson('chuzhenxinxi' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
