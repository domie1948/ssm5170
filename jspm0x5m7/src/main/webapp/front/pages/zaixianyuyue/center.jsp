				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<select name="shijianduan" id="shijianduan">
							...
							<div class="layui-input-block">
								<input type="text" name="jiuzhenmiaoshu" id="jiuzhenmiaoshu" placeholder="就诊描述" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<div class="layui-input-block">
								<img id="jiankangmaImg" style="width: 100px;height: 100px;border-radius: 50%;border: 2px solid #EEEEEE;" src="../../img/avator.png">
								<input type="hidden" id="jiankangma" name="jiankangma" />
							</div>
						</div>
						<div class="layui-form-item">
							<div class="layui-input-block">
								<button type="button" class="layui-btn btn-theme" id="jiankangmaUpload">
							...
							<div class="layui-input-block">
								<input type="text" name="riqi" id="riqi" placeholder="日期" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload'], function() {
				...
				http.request(`${table}/session`, 'get', {}, function(data) {
					...
					form.val("myForm", data.data);
																																																																																					// 图片赋值
					jquery("#jiankangmaImg").attr("src", data.data.jiankangma);
																																																																																				});
